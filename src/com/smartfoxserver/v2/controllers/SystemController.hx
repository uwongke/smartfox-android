...
class SystemController extends BaseController
{
	...
	*/
	...
	private function fnHandshake(msg:IMessage):Void
	{
		...
		sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.HANDSHAKE, evtParams));
	}
	...
	private function fnLogin(msg:IMessage):Void
	{
		...
		if(obj.isNull(BaseRequest.KEY_ERROR_CODE))
		{
			...
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.LOGIN, evtParams));
		}
		...
		else
		{
			...
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.LOGIN_ERROR, evtParams));
		}
	}
	...
	private function fnCreateRoom(msg:IMessage):Void
	{
		...
		if(obj.isNull(BaseRequest.KEY_ERROR_CODE))
		{
			...
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.ROOM_ADD, evtParams));
		}
		...
		else
		{
			...
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.ROOM_CREATION_ERROR, evtParams));
		}
	}
	...
	private function fnJoinRoom(msg:IMessage):Void
	{
		...
		if(sfso.isNull(BaseRequest.KEY_ERROR_CODE))
		{
			...
			*/
			...
			evtParams.room = room;
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.ROOM_JOIN, evtParams));
		}
		...
		else
		{
			...
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.ROOM_JOIN_ERROR, evtParams));
		}
	}
	...
	private function fnUserEnterRoom(msg:IMessage):Void
	{
		...
		if(room !=null)
		{
			...
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.USER_ENTER_ROOM, {user:user, room:room}));
		} 
	}
	...
	private function fnUserCountChange(msg:IMessage):Void
	{
		...
		if(room !=null)
		{
			...
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.USER_COUNT_CHANGE, { room:room, uCount:uCount, sCount:sCount } ));
		}
	}
	...
	*/
	private function fnUserLost(msg:IMessage):Void
	{
		...
		if(user !=null)
		{
			...
			{
				sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.USER_EXIT_ROOM, { user:user, room:room } ));
			}
		}
	}
	...
	private function fnRoomLost(msg:IMessage):Void
	{
		...
		if(room !=null)
		{
			...
			// Fire event			
			evtParams.room = room;
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.ROOM_REMOVE, evtParams));
		}
	}
	...
	private function handlePublicMessage(sfso:ISFSObject):Void
	{
		...
		if(room !=null)
		{
			...
			evtParams.data = sfso.getSFSObject(GenericMessageRequest.KEY_XTRA_PARAMS);
			 ...
			 // Fire event
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.PUBLIC_MESSAGE, evtParams));
		}
		else
	...
	public function handlePrivateMessage(sfso:ISFSObject):Void
	{
		...
		evtParams.data = sfso.getSFSObject(GenericMessageRequest.KEY_XTRA_PARAMS);
		 ...
		 // Fire event
		sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.PRIVATE_MESSAGE, evtParams));
	}
	...
	public function handleModMessage(sfso:ISFSObject):Void
	{
		...
		evtParams.data = sfso.getSFSObject(GenericMessageRequest.KEY_XTRA_PARAMS);
		 ...
		 // Fire event
		sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.MODERATOR_MESSAGE, evtParams));
	}
	...
	public function handleAdminMessage(sfso:ISFSObject):Void
	{
		...
		evtParams.data = sfso.getSFSObject(GenericMessageRequest.KEY_XTRA_PARAMS);
		 ...
		 // Fire event
		sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.ADMIN_MESSAGE, evtParams));
	}
	...
	public function handleObjectMessage(sfso:ISFSObject):Void
	{
		...
		evtParams.message = sfso.getSFSObject(GenericMessageRequest.KEY_XTRA_PARAMS);
		 ...
		 // Fire event
		sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.OBJECT_MESSAGE, evtParams));
	}
	...
	private function fnUserExitRoom(msg:IMessage):Void
	{
		...
		if(room !=null && user !=null)
		{
			...
			// Fire event
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.USER_EXIT_ROOM, evtParams));
		}
		else
	...
	private function fnSetRoomVariables(msg:IMessage):Void
	{
		...
		if(targetRoom !=null)
		{
			...
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.ROOM_VARIABLES_UPDATE, evtParams));
		} 
	...
	private function fnSetUserVariables(msg:IMessage):Void
	{
		...
		if(user !=null)
		{
			...
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.USER_VARIABLES_UPDATE, evtParams));
		}
		else
	...
	private function fnSubscribeRoomGroup(msg:IMessage):Void
	{
		...
		if(sfso.isNull(BaseRequest.KEY_ERROR_CODE))
		{
			...
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.ROOM_GROUP_SUBSCRIBE, evtParams));
		}
		...
		else
		{
			...
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.ROOM_GROUP_SUBSCRIBE_ERROR, evtParams));
		}
	}
	...
	private function fnUnsubscribeRoomGroup(msg:IMessage):Void
	{
		...
		if(sfso.isNull(BaseRequest.KEY_ERROR_CODE))
		{
			...
			// Pass the groupId
			evtParams.groupId = groupId;
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.ROOM_GROUP_UNSUBSCRIBE, evtParams));
		}
		...
		else
		{
			...
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.ROOM_GROUP_UNSUBSCRIBE_ERROR, evtParams));
		}
	}
	...
	private function fnChangeRoomName(msg:IMessage):Void
	{
		...
		if(sfso.isNull(BaseRequest.KEY_ERROR_CODE))
		{
			...
			if(targetRoom !=null)
			{
				...
				evtParams.room = targetRoom;
				sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.ROOM_NAME_CHANGE, evtParams));
			}
		...
		else
		{
			...
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.ROOM_NAME_CHANGE_ERROR, evtParams));
		}
	...
	private function fnChangeRoomPassword(msg:IMessage):Void
	{
		...
		if(sfso.isNull(BaseRequest.KEY_ERROR_CODE))
		{
			...
			if(targetRoom !=null)
			{
				...
				evtParams.room = targetRoom;
				sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.ROOM_PASSWORD_STATE_CHANGE, evtParams));
			}
		...
		else
		{
			...
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.ROOM_PASSWORD_STATE_CHANGE_ERROR, evtParams));
		}
	}
	...
	private function fnChangeRoomCapacity(msg:IMessage):Void
	{
		...
		if(sfso.isNull(BaseRequest.KEY_ERROR_CODE))
		{
			...
			if(targetRoom !=null)
			{
				...
				evtParams.room = targetRoom;
				sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.ROOM_CAPACITY_CHANGE, evtParams));
			}
		...
		else
		{
			...
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.ROOM_CAPACITY_CHANGE_ERROR, evtParams));
		}
	}
	...
	private function fnLogout(msg:IMessage):Void
	{
		...
		sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.LOGOUT, evtParams));
	...
	private function fnSpectatorToPlayer(msg:IMessage):Void
	{
			...
			if(targetRoom !=null)
			{
				if(user !=null)
				{
					if(user.isJoinedInRoom(targetRoom))
					{
						...
						sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.SPECTATOR_TO_PLAYER, evtParams));
					}
					else
		...
		else
		{
			...
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.SPECTATOR_TO_PLAYER_ERROR, evtParams));
		}
	}
	...
	private function fnPlayerToSpectator(msg:IMessage):Void
	{
			...
			if(targetRoom !=null)
			{
				if(user !=null)
				{
					if(user.isJoinedInRoom(targetRoom))
					{
						...
						sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.PLAYER_TO_SPECTATOR, evtParams));
					}
					else
		...
		else
		{
			...
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.PLAYER_TO_SPECTATOR_ERROR, evtParams));
		}
	}
	...
	private function fnFindRooms(msg:IMessage):Void
	{
		...
		sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.ROOM_FIND_RESULT, evtParams));
	}
	...
	private function fnFindUsers(msg:IMessage):Void
	{
		...
		sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.USER_FIND_RESULT, evtParams));
	}
	...
	private function fnInviteUsers(msg:IMessage):Void
	{
		...
		sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.INVITATION, evtParams));
	}
	...
	private function fnInvitationReply(msg:IMessage):Void
	{
		...
		if(sfso.isNull(BaseRequest.KEY_ERROR_CODE))
		{
			...
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.INVITATION_REPLY, evtParams));
		...
		else
		{
			...
			sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.INVITATION_REPLY_ERROR, evtParams));
		}
	}
	...
	private function fnPingPong(msg:IMessage):Void
	{
		...
		var newEvt:SFSEvent = SFSEvent.newInst(SFSEvent.PING_PONG, { lagValue:avg } );
	...
	*/
	private function fnSetUserPosition(msg:IMessage):Void
	{
		...
		sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.PROXIMITY_LIST_UPDATE, evtParams));
	}
	...
	private function fnSetMMOItemVariables(msg:IMessage):Void
	{
		...
		if(mmoRoom !=null)
		{
			...
			if(mmoItem !=null)
			{
				...
				sfs.dispatchEvent(SFSEvent.newInst(SFSEvent.MMOITEM_VARIABLES_UPDATE, evtParams));
			}
		}
	}
