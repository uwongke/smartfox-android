...
class CreateSFSGameRequest extends BaseRequest {
	...
	override public function validate(sfs:SmartFox):Void {
		...
		if (_settings.invitationExpiryTime < InviteUsersRequest.MIN_EXPIRY_TIME
			|| _settings.invitationExpiryTime > InviteUsersRequest.MAX_EXPIRY_TIME)
			errors.push("Expiry time value is out of range("
